...
export const attributes: DocumentAttribute[] = [
  ...
  {
    name: 'before-expand-change',
    description: '行折叠状态发生变化前的回调函数，返回JavaScript中的falsy类型值时会阻止折叠状态变化',
    type: 'Function({ row, column, $index })',
    value: '—',
    default: '—'
  },
  {
    name: 'before-select-change',
    description: '状态发生变化前的回调函数，返回false时会阻止勾选状态的变化',
    type: 'Function(selected, { row, column, store, $index })',
    value: '—',
    default: '—'
  },
  {
    name: 'before-select-all-change',
  ...
  {
    name: 'need-custom-sort',
    description: '结合table-setting配置开放拖拽排序功能',
    type: 'Boolean',
    value: 'true / false',
    default: 'false'
  }
...
export const scopedSlots: DocumentScopedSlot[] = [
  ...
  { name: '—', description: '匿名插槽，当bk-table-column的type属性设置为setting时，通过此插槽提供需设置的内容' }
];

export const settingContent: DocumentAttribute[] = [
  {
    name: 'fields',
    description: '可选的字段列表',
    type: 'Array',
  ...
  {
    name: 'limit',
    description: '配置最多能选择多少个字段，配置该属性后，字段列表将不提供全选功能',
    type: 'Number',
    value: '-',
    default: '-'
  },
  ...
  {
    name: 'display-radio-group',
    description: '字段是否以radio-group形式分类展示，默认单页分类展示，需同时配置category-list属性',
    type: 'Boolean',
    value: 'true / false',
    default: 'false'
  },
  ...
  {
    name: 'resettable',
    description: '是否开启恢复默认功能，默认为false，开启需配置default-size或者default-fields',
    type: 'Boolean',
    value: 'true / false',
    default: 'false'
  },
  {
    name: 'default-size',
    description: '默认表格尺寸，与resettable搭配使用',
    type: 'String',
    value: '-',
    default: '-'
  },
  {
    name: 'default-fields',
    description: '默认字段列表，与resettable搭配使用',
    type: 'Array',
    value: '-',
    default: '-'
  },
...
export const settingContentEvent: DocumentEvent[] = [
  {
    name: 'setting-change',
    description: '表格设置发生变化时的事件',
    parameter: 'Function({ fields, size })'
  },
  {
    name: 'cancel',
    description: '取消配置表格时的事件',
    parameter: '-'
  },
];

export const document: BkDocument = { attributes, scopedSlots, settingContent, settingContentEvent };
